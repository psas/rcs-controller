...
#define CW_SOLENOID_PIN 16 // provides impulse such that the rocket rotates in the clockwise direction
#define CCW_SOLENOID_PIN 15 // provides impulse such that the rocket rotates in the counter-clockwise direction
